...
export type AllFilmsWithVariablesQueryQuery = { allFilms: { edges: Array<{ node: { ' $fragmentRefs'?: { 'FilmItemFragment': FilmItemFragment } } | null } | null> | null } | null };

export type FilmItemFragment = { id: string, title: string | null, releaseDate: string | null, producers: Array<string | null> | null } & { ' $fragmentName'?: 'FilmItemFragment' };
