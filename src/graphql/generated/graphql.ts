...
export type FetchFilmWithVariablesQueryQuery = {
  film: {
    id: string
    title: string | null
    openingCrawl: string | null
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      { kind: 'Field', name: { kind: 'Name', value: 'openingCrawl' } },
...
export const FetchFilmWithVariablesQueryDocument = {
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'fetchFilmWithVariablesQuery' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
  ...
  FetchFilmWithVariablesQueryQuery,
