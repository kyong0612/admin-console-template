...
export type AllFilmsWithVariablesQueryQuery = { allFilms: { films: Array<{ id: string, title: string | null, openingCrawl: string | null, created: string | null } | null> | null } | null };

export type FetchFilmWithVariablesQueryQueryVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type FetchFilmWithVariablesQueryQuery = { film: { id: string, title: string | null, openingCrawl: string | null, created: string | null } | null };
...
export const FetchFilmWithVariablesQueryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"fetchFilmWithVariablesQuery"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"film"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"openingCrawl"}},{"kind":"Field","name":{"kind":"Name","value":"created"}}]}}]}}]} as unknown as DocumentNode<FetchFilmWithVariablesQueryQuery, FetchFilmWithVariablesQueryQueryVariables>;